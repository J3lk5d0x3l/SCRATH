...
const command = {
  ...
  async execute(interaction) {
    ...
    try {
      // Obtiene comandos disponibles del cliente
      ...
      // Agrupa comandos por categoría (si existen)
      ...
      // Construye embed con categorías
      const fields = [];
      ...
      const embed = createInfoEmbed(
        ...
        `Usa \`/help\` para ver esta lista. Total de comandos: **${commands.size}**`,
        fields
      );
      ...
      const embed = createErrorEmbed(
        'Error',
        'No se pudo cargar la lista de comandos. Intenta más tarde.'
      );
      return interaction.reply({ embeds: [embed], ephemeral: true });
    }
  },
